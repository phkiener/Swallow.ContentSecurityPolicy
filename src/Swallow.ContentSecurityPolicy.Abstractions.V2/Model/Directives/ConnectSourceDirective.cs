namespace Swallow.ContentSecurityPolicy.Abstractions.V2.Model.Directives;
...
public sealed class ConnectSourceDirective : FetchDirective<ConnectSourceDirective>;
